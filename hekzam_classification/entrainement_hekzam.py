...
# --- Chargement données ---
dataset_train = HekzamDataset('cases_hekzam', 'cases_hekzam/labels.json', transform=transform_train)
dataset_test  = HekzamDataset('cases_hekzam', 'cases_hekzam/labels.json', transform=transform_test)
...
print("Modèle MNIST chargé — début du fine-tuning sur Hekzam")
...
torch.save(model.state_dict(), "stn_hekzam.pth")
print("Modèle sauvegardé : stn_hekzam.pth")
